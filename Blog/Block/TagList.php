...
class TagList extends Template
{
     ...
     * @param \Umanskiy\Blog\Model\ResourceModel\Tag\CollectionFactory $collectionFactory
     * @param array $data
     */
     ...
     */
    public function _prepareLayout(): TagList
    {
        parent::_prepareLayout();
        $this->pageConfig->getTitle()->set(__('Tag List'));

        $pager = $this->getLayout()->createBlock(Pager::class, 'tag.list.pager');
